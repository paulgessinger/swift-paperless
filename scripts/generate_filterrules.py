...
parser.add_argument(
    "--url",
    type=str,
    default=f"https://raw.githubusercontent.com/paperless-ngx/paperless-ngx/dev/{input_file}",
)
...
try:
    ...
    raw = check_output(
        [gh, "api", f"repos/paperless-ngx/paperless-ngx/commits?path={input_file}"]
    ).decode("utf-8")
