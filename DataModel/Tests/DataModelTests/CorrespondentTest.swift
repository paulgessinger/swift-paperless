...
struct CorrespondentTest {
    ...
    @Test func testEncoding() throws {
        let correspondent = Correspondent(id: 88, documentCount: 0, lastCorrespondence: nil, name: "Aaaaaa", slug: "aaaaaa", matchingAlgorithm: .auto, match: "", isInsensitive: false)
    ...
    func testProtoCorrespondent() throws {
        let correspondent = ProtoCorrespondent(name: "Aaaaaa", matchingAlgorithm: .auto, match: "", isInsensitive: false)
    ...
    func testProtoCorrespondentWithPermissions() throws {
        ...
        var correspondent = ProtoCorrespondent(name: "Aaaaaa", matchingAlgorithm: .auto, match: "", isInsensitive: false, owner: .user(2))
