...
public struct AsnFilterView: View {
  @Binding public var query: FilterState.AsnFilter

  public init(query: Binding<FilterState.AsnFilter>) {
    self._query = query
  }
...
public struct AsnFilterDisplayView: View {
  public let query: FilterState.AsnFilter

  public init(query: FilterState.AsnFilter) {
    self.query = query
  }
