...
public class TipJarStore {
  ...
  public struct TipJarAlert: Identifiable, Sendable {
    public let id = UUID()
  ...
  public var purchasingProductID: String? = nil
  public var alert: TipJarAlert? = nil
...
public enum TipJarStoreError: Error {
