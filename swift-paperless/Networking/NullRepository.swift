...
actor NullRepository: Repository {
  ...
  func download(documentID _: UInt, progress _: (@Sendable (Double) -> Void)? = nil) async throws
    -> URL?
  { nil }
  ...
  func create(correspondent _: ProtoCorrespondent) async throws -> Correspondent {
    throw NotImplemented()
  }
  func update(correspondent _: Correspondent) async throws -> Correspondent {
    throw NotImplemented()
  }
  ...
  func create(documentType _: ProtoDocumentType) async throws -> DocumentType {
    throw NotImplemented()
  }
  ...
  func create(storagePath _: ProtoStoragePath) async throws -> StoragePath {
    throw NotImplemented()
  }
