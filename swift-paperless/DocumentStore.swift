...
final class DocumentStore: ObservableObject, Sendable {
  ...
  func fetchAll() async throws {
    ...
    _ = try await (
      correspondents, documentTypes, tags, savedViews, storagePaths, currentUser, users, groups
    )
  ...
  private func create<E: Sendable, R: Sendable>(
