...
private extension UserPermissions.Operation {
    var icon: String {
        switch self {
        case .view: "eye"
        case .add: "plus"
...
struct PermissionsView: View {
    ...
    private struct Value: View {
        ...
        var body: some View {
            Label(localized: value ? .localizable(.yes) : .localizable(.no), systemImage: value ? "checkmark.circle.fill" : "xmark.circle.fill")
                .labelStyle(.iconOnly)
