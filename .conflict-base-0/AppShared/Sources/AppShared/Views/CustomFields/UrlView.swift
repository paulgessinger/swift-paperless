...
public struct UrlView: View {
  @Binding public var instance: CustomFieldInstance

  @State private var url: String = ""

  @Environment(\.openURL) private var openURL

  public init(instance: Binding<CustomFieldInstance>) {
    _instance = instance
    if case .url(let u) = instance.wrappedValue.value {
...
#Preview {
  @Previewable @State var instance = CustomFieldInstance(
    field: field, value: .url(#URL("https://example.com")))
