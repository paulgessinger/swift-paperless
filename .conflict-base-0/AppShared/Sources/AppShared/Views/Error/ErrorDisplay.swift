...
public struct ErrorDisplay: ViewModifier {
  ...
  public func createAutoDismissTask(duration: Double) -> Task<Void, Never> {
    Task {
  ...
  public init(errorController: ErrorController, offset: CGFloat = 0) {
  ...
  public func body(content: Content) -> some View {
    content
      .overlay(alignment: .top) {
        ...
        case .active(let error, let duration):
          HStack {
            Label(
              error.message,
              systemImage: "xmark"
            ...
            VStack(alignment: .leading) {
              ...
              if error.details != nil {
                Text(.app(.errorAlertTapForDetails))
...
extension View {
  @MainActor public func errorOverlay(errorController: ErrorController, offset: CGFloat = 0)
    -> some View
  {
