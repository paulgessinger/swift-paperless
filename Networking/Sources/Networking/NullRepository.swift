...
public actor NullRepository: Repository {
    ...
    public func create(document _: ProtoDocument, file _: URL, filename _: String) async throws { throw NotImplemented() }
    ...
    public func createNote(documentId _: UInt, note _: ProtoDocument.Note) async throws -> [Document.Note] { [] }
